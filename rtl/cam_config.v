...
#(parameter CLK_F = 100_000_000)
    ...
    localparam SM_IDLE  = 10'd0;
    localparam SM_SEND  = 10'd1;
    localparam SM_DONE  = 10'd2;
    localparam SM_TIMER = 10'd3;
		...
		if(!i_rstn) begin
		    ...
		    SM_state        <= SM_IDLE;
                ...
                case(SM_state)
                    ...
                    SM_TIMER:
                        begin
                            SM_state    <= (timer == 1'b1) ? SM_return_state : SM_TIMER;
                            timer       <= (timer == 1'b1) ?        1'b0        : timer - 1'b1; 
                            o_i2c_start <= 1'b0;      
                        end  
                endcase
            end   
