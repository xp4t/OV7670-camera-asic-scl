#############################################################################
# PPA Sweep — E5: High Effort + Retiming (50 MHz)
# Strategy: Enable retiming to allow Genus to move registers across logic
#           stages to balance path delays — can improve critical path slack
#           at the same clock period, or enable higher frequency.
#############################################################################
set EXPERIMENT    "E5_higheffort_retime_50MHz"
set DESIGN_NAME   "top"
set RTL_ROOT      "../rtl"
set LIB_ROOT      "../lib"
set LEF_ROOT      "../lef"
set OUT_DIR       "sweep/E5"
set REPORT_DIR    "sweep/E5"
