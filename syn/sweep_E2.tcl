#############################################################################
# PPA Sweep — E2: High Effort + Tighter Clock (40 MHz = 25ns)
# Strategy: Push for higher performance. If timing closes, we get a faster
#           design; if it doesn't, we see how much slack is missing.
#############################################################################
set EXPERIMENT    "E2_higheffort_40MHz"
set DESIGN_NAME   "top"
set RTL_ROOT      "../rtl"
set LIB_ROOT      "../lib"
set LEF_ROOT      "../lef"
set OUT_DIR       "sweep/E2"
set REPORT_DIR    "sweep/E2"
...
# Override CLK_TOP_PERIOD to 25ns (40 MHz) before reading SDC
# We use set_db to override via a wrapper approach: read default SDC,
# then override the i_top_clk period inline.
read_sdc $CONSTRAINTS_FILE
# Tighten i_top_clk to 25ns for this experiment
# Override i_top_clk to 25ns (40 MHz)
create_clock -name i_top_clk -period 25.0 [get_ports i_top_clk]
# E2: high effort, no flatten
