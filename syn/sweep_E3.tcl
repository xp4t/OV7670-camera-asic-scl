#############################################################################
# PPA Sweep — E3: Medium Effort (50 MHz)
# Strategy: Lower effort = faster runtime + potentially smaller area/lower
#           power since tool won't upsize aggressively to close timing.
#############################################################################
set EXPERIMENT    "E3_mediumeffort_50MHz"
set DESIGN_NAME   "top"
set RTL_ROOT      "../rtl"
set LIB_ROOT      "../lib"
set LEF_ROOT      "../lef"
set OUT_DIR       "sweep/E3"
set REPORT_DIR    "sweep/E3"
